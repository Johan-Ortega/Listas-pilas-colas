 ...
 * @author maste
 */
public class MenuLCircular extends javax.swing.JFrame {

    /**
     * Creates new form MenuLEnlazadaDoble
     */
    public MenuLCircular() {
        initComponents();
    }
    ...
    public void ActualizarTabla(){
        ...
        for(int i=0; i<Global.lCircular.getTamaño(); i++)  {
            Object [] fila = new Object[4];
            fila[0] = i;
            fila[1] = Global.lCircular.buscarNodo(i).getDato().getNombre(); 
            fila[2] = Global.lCircular.buscarNodo(i).getDato().getTelefono();
            fila[3] = Global.lCircular.buscarNodo(i).getDato().getEdad();
            modelo.addRow(fila); 
        }
    ...
    private void mbtnAñadirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnAñadirMouseClicked
        AgregarContactoLC AgContacto = new AgregarContactoLC();
    ...
    private void mbtnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnEliminarMouseClicked
        ...
        if(index < Global.lCircular.getTamaño()){
            String aux = Global.lCircular.buscarNodo(index).getDato().getNombre();
            JOptionPane.showMessageDialog(jMenu5, "Eliminando el Contacto: " + aux);
            Global.lCircular.eliminar(index);
        }else{
    ...
    private void mbtnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnModificarMouseClicked
        ModificarContactoLC ModContacto = new ModificarContactoLC();
    ...
    private void mbtnConsultarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnConsultarMouseClicked
        int index = Integer.parseInt(JOptionPane.showInputDialog("Introduzca la posicion del contacto: "));
        if(index<=Global.lCircular.getTamaño()){
            Contacto aux = Global.lCircular.buscarNodo(index).getDato();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        Global.lCircular.OrdenarCircularNombre(Global.lCircular); 
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        Global.lCircular.OrdenarCircularEdad(Global.lCircular); 
        JOptionPane.showMessageDialog(jMenuItem3,"Lista Ordenada por edad");        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuLCircular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuLCircular().setVisible(true);
            }
        });
    }
