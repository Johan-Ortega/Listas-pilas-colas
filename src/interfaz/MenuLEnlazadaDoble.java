 ...
 * @author maste
 */
public class MenuLEnlazadaDoble extends javax.swing.JFrame {

    /**
     * Creates new form MenuLEnlazadaDoble
     */
    public MenuLEnlazadaDoble() {
        initComponents();
    }
    ...
    public void ActualizarTabla(){
        ...
        for(int i=0; i<Global.lEnlazadaDoble.getTamaño(); i++)  {
            Object [] fila = new Object[4];
            fila[0] = i;
            fila[1] = Global.lEnlazadaDoble.buscarNodo(i).getDato().getNombre(); 
            fila[2] = Global.lEnlazadaDoble.buscarNodo(i).getDato().getTelefono();
            fila[3] = Global.lEnlazadaDoble.buscarNodo(i).getDato().getEdad();
            modelo.addRow(fila); 
        }
    ...
    private void mbtnAñadirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnAñadirMouseClicked
        AgregarContactoLED AgContacto = new AgregarContactoLED();
    ...
    private void mbtnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnEliminarMouseClicked
        ...
        if(index < Global.lEnlazadaDoble.getTamaño()){
            String aux = Global.lEnlazadaDoble.buscarNodo(index).getDato().getNombre();
            JOptionPane.showMessageDialog(jMenu5, "Eliminando el Contacto " + aux);
            Global.lEnlazadaDoble.eliminar(index);
        }else{
    ...
    private void mbtnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mbtnModificarMouseClicked
        ModificarContactoLED MContacto = new ModificarContactoLED();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        Global.lEnlazadaDoble.OrdenarEnlazadaDobleNombre(Global.lEnlazadaDoble); 
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        Global.lEnlazadaDoble.OrdenarEnlazadaDobleEdad(Global.lEnlazadaDoble); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuLEnlazadaDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuLEnlazadaDoble().setVisible(true);
            }
        });
    }
